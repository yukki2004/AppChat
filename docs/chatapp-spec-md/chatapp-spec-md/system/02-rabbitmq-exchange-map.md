...
| **user.exchange** | topic | Identity Svc | user.registered, user.profile_updated, user.blocked, user.new_device_login, friend.request_sent, friend.accepted, friend.removed, user.block_set, user.block_removed |
